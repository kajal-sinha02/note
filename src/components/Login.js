  ...
  return (
    <div className='container mx-auto px-4 py-8 bg-gray-800 rounded-md shadow-md'>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-white"> 
          <label htmlFor="password" className="block mb-1">Password           <button type="button" onClick={togglePasswordVisibility} >
              {showPassword ? <i className="fa-solid fa-eye"></i> : <i className="fa-solid fa-eye-slash"></i>}
            </button></label>
          <input type={showPassword ? "text" : "password"} minLength={5} className="w-full px-3 py-2 bg-gray-700 text-white rounded-md focus:outline-none focus:ring focus:ring-blue-500" id="password" name='password' value={credentials.password} onChange={onchange} />
        </div>
